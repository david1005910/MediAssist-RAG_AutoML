    ...
    <div className="min-h-screen">
      ...
      <main className="flex h-[calc(100vh-64px)]">
        ...
        <div className="w-64 p-4 overflow-y-auto flex-shrink-0 metal-sidebar">
          ...
          {/* Legend */}
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 mb-2">범례</label>
          ...
          {selectedNode && (
            <div className="mb-4 rounded-metal p-3"
              ...
              <h3 className="text-sm font-semibold text-gray-800 mb-1">{selectedNode.label}</h3>
              <span
              ...
              {Object.entries(selectedNode.properties).slice(0, 5).map(([key, value]) => (
                <div key={key} className="text-xs">
                  ...
                  <span className="text-gray-700">{String(value).substring(0, 60)}</span>
                </div>
              ))}
            </div>
          )}
          ...
          {/* Stats */}
          <div className="text-xs text-gray-600 space-y-1 p-3 rounded-metal"
        ...
        <div className="flex-1 relative">
          ...
          {!neo4jStatus?.connected ? (
            <div className="flex items-center justify-center h-full text-gray-600 pt-12">
        ...
        <div className="w-80 flex-shrink-0 flex flex-col metal-sidebar" style={{ borderLeft: '1px solid rgba(255,255,255,0.05)' }}>
          ...
          {selectedJsonData && (
            <div className="px-3 pb-3 text-xs text-gray-600 border-t border-white/5 pt-2">
