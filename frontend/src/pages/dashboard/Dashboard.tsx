    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          >
            <div className="text-3xl mb-3 opacity-80 group-hover:opacity-100 transition-opacity">🧬</div>
            <h3 className="text-lg font-semibold text-metal-text-light">RNA 분석</h3>
            <p className="mt-2 text-sm text-metal-text-muted">
              RNA 서열을 분석하여 질병 예측 및 위험도 평가를 수행합니다.
            </p>
            <div className="mt-4 text-xs opacity-70" style={{ color: '#4DD0E1' }}>
              BERT + Hybrid N-gram
            </div>
          </Link>
          ...
          >
            <div className="text-3xl mb-3 opacity-80 group-hover:opacity-100 transition-opacity">🤖</div>
            <h3 className="text-lg font-semibold text-metal-text-light">AutoML</h3>
            <p className="mt-2 text-sm text-metal-text-muted">
              자동 하이퍼파라미터 최적화 및 모델 선택을 수행합니다.
            </p>
            <div className="mt-4 text-xs opacity-70" style={{ color: '#FF8A65' }}>
              Optuna + Ensemble
            </div>
          </Link>
        </div>
