    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          ...
          >
            <span className="font-medium text-cyan-300">위험도 평가 기준 및 유사도 검색 시스템 안내</span>
            <span className="text-cyan-300">{showCriteriaInfo ? '▲ 닫기' : '▼ 펼치기'}</span>
          </button>
            ...
            <div className="mt-4 metal-card p-6 space-y-6">
                  ...
                  <table className="w-full text-sm border-collapse">
                    <thead>
                      <tr style={{ background: 'linear-gradient(180deg, #2C3036 0%, #23272B 100%)' }}>
                        <th className="border border-gray-200 px-3 py-2 text-left text-gray-800">요소</th>
                        <th className="border border-gray-200 px-3 py-2 text-left text-gray-800">조건</th>
                        <th className="border border-gray-200 px-3 py-2 text-left text-gray-800">점수</th>
                      </tr>
                    </thead>
                    <tbody className="text-gray-700">
                      ...
                      <tr>
                        ...
                        <td className="border border-gray-200 px-3 py-2 text-orange-600 font-medium">+15점</td>
                      </tr>
                      <tr style={{ background: 'rgba(0,0,0,0.2)' }}>
                        ...
                        <td className="border border-gray-200 px-3 py-2 text-orange-600 font-medium">+10점</td>
                      </tr>
                      <tr>
                        ...
                        <td className="border border-gray-200 px-3 py-2 text-red-600 font-medium">+15점</td>
                      </tr>
                      <tr>
                      ...
                      <tr style={{ background: 'rgba(0,0,0,0.2)' }}>
                        ...
                        <td className="border border-gray-200 px-3 py-2 text-yellow-600 font-medium">+5점</td>
                      </tr>
                      <tr>
              ...
              <div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse">
                    <thead>
                      <tr style={{ background: 'linear-gradient(180deg, #2C3036 0%, #23272B 100%)' }}>
                        <th className="border border-gray-200 px-3 py-2 text-left text-gray-800">레벨</th>
                        <th className="border border-gray-200 px-3 py-2 text-left text-gray-800">점수 범위</th>
                        <th className="border border-gray-200 px-3 py-2 text-left text-gray-800">의미</th>
                      </tr>
                    </thead>
                    <tbody className="text-gray-700">
                      <tr style={{ background: 'rgba(0,0,0,0.2)' }}>
              ...
              <div>
                ...
                <div className="rounded-metal p-4 space-y-3"
                  ...
                  <div>
                    <h4 className="font-medium text-orange-300 mb-1">1. Sparse Search (SPLADE/BM42)</h4>
                    <p className="text-sm text-gray-300">
                      키워드 기반 희소 벡터 검색입니다. 정확한 용어 매칭에 강점이 있습니다.
                      <br />
                      <code className="bg-black/30 px-1 rounded text-xs text-gray-400">가중치: 30%</code>
                    </p>
                  </div>
                  <div>
                    <h4 className="font-medium text-cyan-300 mb-1">2. Dense Search (BioBERT)</h4>
                    <p className="text-sm text-gray-300">
                      의학 전문 언어 모델을 사용한 의미 기반 밀집 벡터 검색입니다.
                      문맥과 개념 이해에 강점이 있습니다.
                      <br />
                      <code className="bg-black/30 px-1 rounded text-xs text-gray-400">가중치: 70%</code>
                    </p>
                  </div>
                  <div>
                    <h4 className="font-medium mb-1 text-purple-300">3. QdrantDB 하이브리드 검색</h4>
                    <p className="text-sm text-gray-300">
                  ...
                  <div>
                    <h4 className="font-medium text-green-300 mb-1">4. 최종 점수 계산</h4>
                    <p className="text-sm text-gray-300">
                      <code className="bg-black/30 px-1 rounded text-xs text-gray-400">종합 점수 = (Sparse × 0.3) + (Dense × 0.7)</code>
                      <br />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="metal-card p-6">
              <h2 className="text-lg font-semibold text-gray-800 mb-4">자연어 증상 입력</h2>
              <textarea
                value={freeText}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div className="metal-card p-6">
                <h2 className="text-lg font-semibold text-gray-800 mb-4">증상 목록</h2>
                ...
                {fields.map((field, index) => (
                  <div key={field.id} className="flex gap-2 mb-3 items-start">
                    ...
                    <button
                      ...
                      className="px-2 py-2 text-red-600 hover:text-red-500 transition-colors"
                    >
                      ✕
                    </button>
                  </div>
                ...
                <button
                  ...
                  className="text-cyan-700 hover:text-cyan-600 text-sm transition-colors"
                >
                  + 증상 추가
                </button>
              </div>
              ...
              {/* Patient Info */}
              <div className="metal-card p-6">
                <h2 className="text-lg font-semibold text-gray-800 mb-4">환자 정보 (선택)</h2>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm text-gray-700 mb-1">나이</label>
                    <input
                      type="number"
              ...
              <>
                ...
                <div className="rounded-metal p-6"
                  ...
                  <div className="flex justify-between items-center mb-4">
                    <h2 className="text-lg font-semibold text-gray-800">위험도 평가</h2>
                  ...
                  {result.risk_assessment.factors.length > 0 && (
                    <div className="mb-4">
                      <h3 className="text-sm font-medium mb-2 text-gray-800">위험 요인</h3>
                  ...
                  {result.risk_assessment.recommendations.length > 0 && (
                    <div>
                      <h3 className="text-sm font-medium mb-2 text-gray-800">권장 사항</h3>
                      <ul className="text-sm space-y-1" style={{ color: getRiskLevelStyle(result.risk_assessment.risk_level).text }}>
                ...
                {/* Disease Predictions */}
                <div className="metal-card p-6">
                  <h2 className="text-lg font-semibold text-gray-800 mb-4">예측 질환</h2>
                    ...
                    {result.predictions.map((pred, index) => (
                      <div key={index} className="rounded-metal p-4"
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            <h3 className="font-medium text-gray-800">{pred.disease}</h3>
                            <p className="text-sm text-gray-600">ICD-10: {pred.icd_code}</p>
                            {pred.description && (
                ...
                {/* Extracted Symptoms */}
                <div className="metal-card p-6">
                  <h2 className="text-lg font-semibold text-gray-800 mb-4">분석된 증상</h2>
